            ...
            <div class="container mx-auto">
                <div class="p-40">
                    <div class="justify-center">
                        ...
                        <p class="text-white">
                            Belum punya akun? Daftar  <br>
                            sekarang dan mulai belajar gratis! <br>
                        </p>
                        <div class="flex flex-col items-center space-y-4">
                            ...
                            <div class="flex flex-col items-start space-y-2">
                                <label for="username" class="text-white pl-2">
                                    username
                                </label>
                            ...
                            <div class="flex flex-col items-start space-y-2">
                                <label for="confirm_password" class="text-white pl-2">
                                confirm password
                                </label>
                            ...
                            <div class="mt-3">
                                <button
                                    class="bg-yellow-300 rounded-[12px] w-[412px] h-[78px] p-5 font-medium text-2xl">Register</button>
                            </div>`
                        </div>
                    </div>
                </div>
